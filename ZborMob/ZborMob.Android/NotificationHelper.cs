...
namespace ZborMob.Droid
{
    class NotificationHelper : INotification
    {
        ...
        public void DeleteNotification(List<int> ids)
        {
            ...
            {
                if (!ids.Contains(not.Id))
                    notificationManager.Cancel(not.Id);
            }
        }
        public void CreateNotification(Guid id, String title, String message)
        {
            try
            {
                ...
                notificationManager.Notify(id.GetHashCode(), mBuilder.Build());
